...
game: $(SRC)
	$(CC) -I/usr/include/SDL2 -gdwarf-4 -O3 -std=c++11 $(SRC) $(EXTRA) -o $(GAME) -IArduinoCore-avr/variants/leonardo -I. -I./engine -I./model -Itensorflow -I./model/eigen -include port.h -Wno-narrowing -fpermissive -w -DNDEBUG -fdata-sections -ffunction-sections -Wl,--gc-sections
